        ...
        <>
            ...
            </div>
            {
                openFilter ? <div className='bg-gray-100 p-2 md:hidden'>
                    ...
                    <div className='flex flex-col gap-2 mt-3 max-h-56 overflow-y-auto'>
                        {
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="range" min="0" max="5000" name="" id="" value={priceRange[1]} onChange={(e) => setPriceRange([priceRange[0], Number(e.target.value)])} className='transition-all w-50' />
                    </div>
